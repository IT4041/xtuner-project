...
public class WeekZeroAuto extends SequentialCommandGroup {
  ...
  public WeekZeroAuto(Pivot in_pivot, Intake in_intake, FiringHead in_firingHead, MasterController in_masterController,
    ...
    addCommands(new InstantCommand(() -> m_pivot.GoToShootingMidRange(), m_pivot)); // 37
    addCommands(new WaitCommand(0.5));
    addCommands(new InstantCommand( () -> m_firingHead.setTransportMotorSpeed(Constants.FiringHeadConstants.ShootTransportMotorSpeed), m_firingHead));
    ...
    addCommands( new InstantCommand(() -> m_pivot.GoToStarting(), m_pivot));
  }
}
